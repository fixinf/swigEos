...
def fun(U):
    ...
    print(wr.delta_phi.foldername)
    # exit()
    for m in [wr.delta_phi, wr.delta_phi_sigma, wr.delta_only]:
...
# ulist = [-55., -60., -65]
ulist = np.array([-50., -55., -60., -65., -70.,-90., -100., -110.,-130.,-150.,-157.])
res = []
# ulist=[-150.]
for u in ulist:
# for u in [-148.]:
...
np.savetxt(join(wr.foldername, 'nc_dp_U.dat'), res)